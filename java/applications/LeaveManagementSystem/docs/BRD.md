...
- Support basic leave types such as vacation, sick leave, compensatory, , unpaid leave, Casual Leave, Maternity Leave, Paternity Leave, Menstrual Leave, Study Leave, Sabbatical leave.
...
- The Syatem shall allow leave submission only for leave types which are active.

#### 6.1.1 Supported Leave Types
...
### 6.2 DIfferent Status codes of a Leave
- A submitted leave shall have one of the following status
...
- The system shall allow an employee to view submitted leave requests of all kind of status codes.
...
- The initial planned leave types include the followling: vacation, sick leave, compensatory, unpaid leave, Casual Leave, Maternity Leave, Paternity Leave, Menstrual Leave, Study Leave, Sabbatical leave.
...
- Basic leave types are planned to include vacation, sick leave, compensatory, unpaid leave, Casual Leave, Maternity Leave, Paternity Leave, Menstrual Leave, Study Leave, Sabbatical leave.
...
- The initial leave types are expected to include vacation, sick leave, compensatory, unpaid leave, Casual Leave, Maternity Leave, Paternity Leave, Menstrual Leave, Study Leave, Sabbatical leave.
