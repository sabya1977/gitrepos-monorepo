...
The Employee Leave Management System is a learning project for building a backend-focused business application with Java 25 (LTS) + Spring Boot, Oracle 26ai, Visual Studio Code, Git, and GitHub Copilot Agent.
...
AI agents must not assume xUnit, NUnit, MSTest, Playwright, Cypress, Vitest, Jest, Testcontainers, or any other test tooling until a decision is made.
...
- Java solution or project files.
...
- Java 25 and Spring Boot is intended for backend API development.
