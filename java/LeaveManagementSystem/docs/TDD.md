...
The planned solution will provide Java 25 (LTS) + Spring Boot that supports the core leave workflow:
...
- Database access: Spring JDBC (SimpleJdbcCall).
...
Client or API Consumer
        |
        v
Java 25 (LTS) + Spring Boot Web API
        |
        v
...
- API Style: REST API: **Confirmed**.
- Application Architecture: Pragmatic Clean Architecture: **Confirmed**.
- Java 25 (LTS) + Spring Boot for API endpoints: **Confirmed**.
- Spring JDBC (SimpleJdbcCall) for database access: **Confirmed**.
- Communication Format: JSON over HTTPS: **Confirmed**.
...
| -------------------------------- | ---------------------------- | ------------- |
| Backend Language                 | Java 25 (LTS)                | Confirmed     |
| Backend Framework                | Spring Boot                  | Confirmed     |
| API framework                    | Spring MVC                   | Confirmed     |
| Build Tool                       | Apache Maven                 | Confirmed     |
| REST API                         | Spring MVC                   | Confirmed     |
| Dependency Injection             | Spring IoC Container         | Confirmed     |
| Database Access                  | Spring JDBC (SimpleJdbcCall) | Confirmed     |
| JSON Serialization               | Jackson                      | Confirmed     |
...
- Expose HTTP endpoints using Spring Boot.
...
- Use Spring JDBC (SimpleJdbcCall) to execute database queries and commands.
...
- Basic leave types such as vacation, sick leave, compensatory, unpaid leave, Casual Leave, Maternity Leave, Paternity Leave, Menstrual Leave, Study Leave, Sabbatical leave.
...
The API will be implemented using Spring Boots.
...
- Logging framework or providers beyond Java 25 (LTS) + Spring Boot defaults.
...
- Basic leave types are planned to include vvacation, sick leave, compensatory,  unpaid leave, Casual Leave, Maternity Leave, Paternity Leave, Menstrual Leave, Study Leave, Sabbatical leave.
