...
create or replace package dollarr_utils2 as

  procedure invalid_rowid (docid number);

end dollarr_utils2;
/
show errors

create or replace package body dollarr_utils2 as

  procedure invalid_rowid (docid number) as
    work   blob;
    buff   raw(14) := hextoraw('1000000000000000000000000000');
    row    integer;
    offset integer;
    rcount integer;
    rsize  integer;
