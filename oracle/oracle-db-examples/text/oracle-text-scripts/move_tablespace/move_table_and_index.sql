...
create table foo(bar varchar2(50)) tablespace users;
...
alter table foo move tablespace newtbsp;
...
-- check all objects (including the base table FOO) are in the NEWTBSP tablespace
