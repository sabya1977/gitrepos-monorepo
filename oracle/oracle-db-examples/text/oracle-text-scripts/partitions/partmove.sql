...
alter table bike_items move partition p1 tablespace new_tbs update global indexes parallel 4;

alter index bike_items_idx rebuild partition p1 parallel 4;
