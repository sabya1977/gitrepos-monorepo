...
select token_text from DR$STOPTEST_NDX$I order by token_text;

select token_text from DR$STOPTEST2_NDX$I order by token_text;

-- find differences 

select t1.token_text from DR$STOPTEST_NDX$I t1 where t1.token_text not in
  (select t2.token_text from DR$STOPTEST2_NDX$I t2 )
  order by t1.token_text;

select t2.token_text from DR$STOPTEST2_NDX$I t2 where t2.token_text not in
