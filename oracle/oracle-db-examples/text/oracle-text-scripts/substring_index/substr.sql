...
insert into mytable values ('exception');
--insert into mytable values ('grace');
--insert into mytable values ('roger');
--insert into mytable values ('bling');
--insert into mytable values ('wonga');
...
exec ctx_ddl.set_attribute('mywordlist', 'wildcard_maxterms', '4')
