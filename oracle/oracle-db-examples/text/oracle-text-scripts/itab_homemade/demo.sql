-- note: this prototype was developed before STAGE_ITAB became available
-- it does a similar job, but using a wholly-separate base table and index
-- it may still have some advantages over STAGE_ITAB
