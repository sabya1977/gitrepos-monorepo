...
create user testuser2 identified by testuser2 default tablespace users temporary tablespace temp quota unlimited on users;

grant connect,resource,ctxapp to testuser2;

connect testuser2/testuser2
