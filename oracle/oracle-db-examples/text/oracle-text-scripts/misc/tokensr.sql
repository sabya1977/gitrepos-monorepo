...
print 'MARTEDÌ'
select count(*) from unisys.dbo.news where contains (text, 'MARTEDÌ')
print 'INTORNO'
...
print 'SOCIETÀ'
select count(*) from unisys.dbo.news where contains (text, 'SOCIETÀ')
print 'COMMISSIONE'
...
print 'RESPONSABILITÀ'
select count(*) from unisys.dbo.news where contains (text, 'RESPONSABILITÀ')
print 'VEDERE'
...
print 'LIBERTÀ'
select count(*) from unisys.dbo.news where contains (text, 'LIBERTÀ')
print 'CONTI'
...
print 'CIOÈ'
select count(*) from unisys.dbo.news where contains (text, 'CIOÈ')
print 'FEBBRAIO'
...
print 'POSSIBILITÀ'
select count(*) from unisys.dbo.news where contains (text, 'POSSIBILITÀ')
print 'SICURO'
...
print 'REALTÀ'
select count(*) from unisys.dbo.news where contains (text, 'REALTÀ')
print 'UNICA'
...
print 'QUALITÀ'
select count(*) from unisys.dbo.news where contains (text, 'QUALITÀ')
print 'AMICI'
...
print 'VERITÀ'
select count(*) from unisys.dbo.news where contains (text, 'VERITÀ')
print 'SAPERE'
...
print 'DIFFICOLTÀ'
select count(*) from unisys.dbo.news where contains (text, 'DIFFICOLTÀ')
print 'POSIZIONE'
...
print 'AUTORITÀ'
select count(*) from unisys.dbo.news where contains (text, 'AUTORITÀ')
print 'SERGIO'
...
print 'ATTIVITÀ'
select count(*) from unisys.dbo.news where contains (text, 'ATTIVITÀ')
print 'FORZA'
...
print 'UNITÀ'
select count(*) from unisys.dbo.news where contains (text, 'UNITÀ')
print 'CHIEDERE'
...
print 'CITTÀ'
select count(*) from unisys.dbo.news where contains (text, 'CITTÀ')
print 'NOTTE'
...
print 'NECESSITÀ'
select count(*) from unisys.dbo.news where contains (text, 'NECESSITÀ')
print 'AGOSTO'
...
print 'FARÀ'
select count(*) from unisys.dbo.news where contains (text, 'FARÀ')
print 'ACCANTO'
...
print 'VERRÀ'
select count(*) from unisys.dbo.news where contains (text, 'VERRÀ')
print 'PASSO'
...
print 'LUNEDÌ'
select count(*) from unisys.dbo.news where contains (text, 'LUNEDÌ')
print 'CONFERMA'
...
print 'VENERDÌ'
select count(*) from unisys.dbo.news where contains (text, 'VENERDÌ')
print 'MERCOLEDÌ'
select count(*) from unisys.dbo.news where contains (text, 'MERCOLEDÌ')
print 'AZIONE'
...
print 'GIOVEDÌ'
select count(*) from unisys.dbo.news where contains (text, 'GIOVEDÌ')
print 'ACQUA'
...
print 'NOVITÀ'
select count(*) from unisys.dbo.news where contains (text, 'NOVITÀ')
print 'FRANCESE'
...
print 'UNIVERSITÀ'
select count(*) from unisys.dbo.news where contains (text, 'UNIVERSITÀ')
print 'INIZIO'
...
print 'METÀ'
select count(*) from unisys.dbo.news where contains (text, 'METÀ')
print 'IDEA'
