...
print 'POTRÀ'
select count(*) from unisys.dbo.news where contains (text, 'POTRÀ')
print 'VERRÀ'
...
print 'AVRÀ'
select count(*) from unisys.dbo.news where contains (text, 'AVRÀ')
print 'DOVRÀ'
select count(*) from unisys.dbo.news where contains (text, 'DOVRÀ')
print 'POTREBBE'
