...
--
exec ctx_ddl.drop_preference('&&INDEXNAME._LX')
exec ctx_ddl.drop_preference('&&INDEXNAME._WL')
exec ctx_ddl.drop_preference('&&INDEXNAME._ST')
exec ctx_ddl.drop_preference('&&INDEXNAME._DS')
exec ctx_ddl.drop_section_group('&&INDEXNAME._SG')
